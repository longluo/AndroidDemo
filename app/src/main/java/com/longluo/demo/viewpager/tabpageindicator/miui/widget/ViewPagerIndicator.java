package com.longluo.demo.viewpager.tabpageindicator.miui.widget;
...
public class ViewPagerIndicator extends LinearLayout {
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.MIUIViewPagerIndicator);
        mTabVisibleCount = a.getInt(R.styleable.MIUIViewPagerIndicator_item_count,
                COUNT_DEFAULT_TAB);
