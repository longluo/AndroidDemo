package com.longluo.demo.mediamanager;
 ...
 */
public class MediaManagerDemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mediamanager_demo);
    ...
    private void openFileChooser() {
        ...
        try {
            ...
            Toast.makeText(MediaManagerDemoActivity.this, "请安装文件管理器", Toast.LENGTH_SHORT).show();
        }
    }
