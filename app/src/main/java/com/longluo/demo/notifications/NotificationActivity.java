package com.longluo.demo.notifications;
...
public class NotificationActivity extends BaseActivity implements
    ...
    public void showCzNotify() {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0,
                getIntent(), 0);
        mBuilder.setSmallIcon(R.drawable.ic_launcher).setTicker("常驻通知来了")
                .setContentTitle("常驻测试").setContentText("使用cancel()方法才可以把我去掉哦")
