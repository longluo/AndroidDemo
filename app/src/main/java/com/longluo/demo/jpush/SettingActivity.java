package com.longluo.demo.jpush;
...
public class SettingActivity extends InstrumentedActivity implements
        OnClickListener {
    ...
    private void setPushTime() {
        ...
        if (startime > endtime) {
            Toast.makeText(SettingActivity.this, "开始时间不能大于结束时间",
        ...
        // 调用JPush api设置Push时间
        JPushInterface.setPushTime(getApplicationContext(), days, startime,
                endtime);
        ...
        mEditor.commit();
        Toast.makeText(SettingActivity.this, R.string.setting_su,
                Toast.LENGTH_SHORT).show();
    }
