package com.longluo.demo.advancedtextview;
...
public class AdvancedTextViewActivity extends ListActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        demos.add(new Demo(this, AnimatedCompoundDrawableActivity.class,
                R.string.animated_compound_drawable,
                R.string.animated_compound_drawable_desc));
        ...
        demos.add(new Demo(this, FromHtmlActivity.class, R.string.from_html,
                R.string.from_html_desc));

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            demos.add(new Demo(this, FractionActivity.class, R.string.fraction,
                    R.string.fraction_desc));
        }
        ...
        demos.add(new Demo(this, AnimatedRainbowSpanActivity.class,
                R.string.animated_rainbow_span,
                R.string.animated_rainbow_span_desc));
        ...
        demos.add(new Demo(this, EmojiActivity.class, R.string.emoji,
                R.string.emoji_desc));

        SimpleAdapter adapter = new SimpleAdapter(this, demos,
                android.R.layout.simple_list_item_2, new String[]{
                Demo.KEY_TITLE, Demo.KEY_SUBTITLE}, new int[]{
