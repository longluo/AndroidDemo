...
public class EventHandler implements OnClickListener {
    ...
    private void display_dialog(int type) {
            ...
            case MANAGE_DIALOG:
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int index) {
                        ...
                        switch (index) {
                            case 0:
                                i = new Intent(mContext, ProcessManagerDemoActivity.class);
    	...
    	*/
                            case 1:
                                i = new Intent(mContext, AppBackupDemoActivity.class);
                                mContext.startActivity(i);
                                break;
                        }
                    }
    ...
    public class TableRow extends ArrayAdapter<String> {
        ...
        public TableRow() {
            super(mContext, R.layout.layout_app_backup_item, mDataSource);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.layout_app_backup_item, parent, false);
