package com.longluo.demo.areachartsview;
 ...
 */
public class AreaChartsViewDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_areachartsview_demo);
