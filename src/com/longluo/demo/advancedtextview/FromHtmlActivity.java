...
import com.longluo.demo.BuildConfig;
...
public class FromHtmlActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText(Html.fromHtml(html, new ResouroceImageGetter(this),
				null));
	...
	private static class ResouroceImageGetter implements Html.ImageGetter {
		...
		public Drawable getDrawable(String source) {
			int path = context.getResources().getIdentifier(source, "drawable", "com.longluo.demo");
