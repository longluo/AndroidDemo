	...
	private void startSwapAnim(final int pos){
		...
		valueAnimator.addUpdateListener(new AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				circle1.x = (float)(centerX + radius * Math.cos(Math.toRadians(angle)));
				circle1.y = (float)(centerY + radius * Math.sin(Math.toRadians(angle)));
				circle2.x = (float)(centerX + radius * Math.cos(Math.toRadians(180+angle)));
				circle2.y = (float)(centerY + radius * Math.sin(Math.toRadians(180+angle)));
				invalidate();
			}
		});    
