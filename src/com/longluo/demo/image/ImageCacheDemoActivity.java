package com.longluo.demo.image;
...
public class ImageCacheDemoActivity extends Activity implements
		OnScrollListener {
	private static final String TAG = "ImageCacheDemoActivity";
	...
	private void initData() {
		...
		int screenWidth = ScreenUtils.getDisPlayMetrics(this).widthPixels;
		int space = (int) DensityUtils.dp2px(this, 20f);
		mImageWidth = (screenWidth - space) / 3;
		mIsWifi = NetworkUtils.isWifi(this);
		if (mIsWifi) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.layout_image_list_item, parent, false);
			...
			if (mIsGridViewIdle && mCanGetBitmapFromNetWork) {
				...
				mImageLoader.bindBitmap(uri, imageView, mImageWidth,
						mImageWidth);
			}
			return convertView;
		}
