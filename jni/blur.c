...
/*
 * com.longluo.demo.grahpic
 */
JNIEXPORT void JNICALL Java_com_longluo_demo_graphic_NativeBlurProcess_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
